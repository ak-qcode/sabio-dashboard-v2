...
import {CheckCircleIcon, InformationCircleIcon, ExclamationTriangleIcon, XCircleIcon} from '@heroicons/vue/24/outline'
...
onMounted(async () => {
  ...
  if (auth.isLoggedIn && router.currentRoute.value.name === "login") {
    notify({
      ...
      text: "You can go to the home page of your dashboard unless you want to log in another account",
      type: "info",
    }, 7500)
  }
})
    ...
    <NotificationGroup>
      <div aria-live="assertive" class="pointer-events-none fixed inset-0 flex items-end px-4 py-6 sm:items-start sm:p-6 z-50">
        <div class="flex w-full flex-col items-center space-y-4 sm:items-end">
          <Notification enter-active-class="transform ease-out duration-300 transition"
