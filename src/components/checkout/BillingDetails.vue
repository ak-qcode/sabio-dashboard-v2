      ...
      <div class="sm:col-span-3">
        ...
        <div class="mt-2">
          <input id="first-name"
                 ...
                 class="block w-full rounded-md border-0 py-1.5 text-dop-color shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                 name="first-name"
                 type="text"/>
        </div>
      </div>
      ...
      <div class="sm:col-span-4">
        ...
        <div class="mt-2">
          <select id="countryCode"
                  ...
                  class="block w-full rounded-md border-0 py-1.5 text-dop-color shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:max-w-xs sm:text-sm sm:leading-6"
                  name="countryCode">
