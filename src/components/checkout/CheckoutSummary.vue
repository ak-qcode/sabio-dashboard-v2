    ...
    <div class="mt-4 rounded-lg border border-gray-200 bg-white shadow-sm">
      <dl class="space-y-6 px-4 py-6 sm:px-6">
        <div class="flex items-center justify-between">
          <dt class="text-lg font-semibold">Account balance</dt>
          <dd class="text-gray-900 text-lg font-semibold">
      ...
      <dl class="space-y-6 border-t border-gray-200 px-4 py-6 sm:px-6">
        <form @submit="applyCoupon" @reset="resetCouponState">
          ...
          <div class="mt-3 flex space-x-4">
            ...
            <button v-if="!couponApplied" class="rounded-md bg-gray-200 px-4 text-sm font-medium text-gray-600 hover:bg-gray-300 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 focus:ring-offset-gray-50"
                    type="submit">
              Apply
            </button>
